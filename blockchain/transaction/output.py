...
class Output:
    ...
    def __init__(self, index: int = None, value: float = None, script_public_signature: str = None,
                 public_key: str = None):
        self.index = index
        self.value = value
    ...
    def from_json(self, output_document: dict):
        ...
        self.script_public_signature = output_document['script_public_signature']
